...
function HomePage() {
  return (
    <section class="bg-center bg-no-repeat bg-gray-400 bg-blend-multiply" style={{ backgroundImage: `url(${freelance})` }}>
...
¡Tu no puedes quedarte atrás!</p>
        <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-black rounded-lg bg-fed049 hover:bg-fcbe08 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                Contacta Conmigo
