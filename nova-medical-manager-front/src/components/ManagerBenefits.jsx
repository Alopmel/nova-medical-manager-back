  ...
  const cardsData = [
    {
      ...
      description: 'A través de perfiles en redes sociales, llegarás a tu público objetivo',
    },
    {
      ...
      description: 'Tu audiencia participará más, generando engagement y lealtad.',
    },
    {
      ...
      description: 'Transmitirá los valores de tu negocio y creará una imagen positiva',
    },
    {
      ...
      description: 'Actuará rápidamente en situaciones delicadas para proteger tu reputación',
    },
  ];
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          <h1 className="font-bold text-3xl sm:text-4xl md:text-[40px] text-dark mb-4 text-gray-900">
            ¿Cuáles son los beneficios de contar con un Community Manager en tu equipo?
          </h1>
        </div>
