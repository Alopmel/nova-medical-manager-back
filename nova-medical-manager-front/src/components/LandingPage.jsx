...
function LandingPage({ title, description }) {
  return (
    <section className="flex justify-between items-center max-w-[1240px] mx-auto px-4 bg-center bg-no-repeat bg-gray-400 bg-blend-multiply" style={{ backgroundImage: `url(${freelance})` }}>
      <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
          <a href="#" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-black rounded-lg bg-fed049 hover:bg-fcbe08 focus:ring-4">
            Contacta Conmigo
