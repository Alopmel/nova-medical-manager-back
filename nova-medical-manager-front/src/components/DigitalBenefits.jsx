  ...
  const cardsData = [
    {
      ...
      description: 'Optimiza tu sitio web y presencia en línea para retener visitantes y aumentar conversiones',
    },
    {
      ...
      description: 'Diseñamos una estrategia digital adaptada a tus necesidades, maximizando recursos y enfoque',
    },
    {
      ...
      description: 'Implementamos tácticas de marketing digital probadas para potenciar tus ventas en línea',
    },
    {
      ...
      title: 'Monitoreo y análisis continuo',
      description: 'Obtén informes detallados y toma decisiones informadas para optimizar tus estrategias',
    },
  ];
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          <h1 className="font-bold text-3xl sm:text-4xl md:text-[40px] text-dark mb-4 text-gray-900">
            ¿Cuáles son los beneficios de contar con una Asesoría en tu equipo?
          </h1>
        </div>
