    ...
    const cardsData = [
        {
          ...
          title: 'Convierte seguidores en clientes',
        ...
        },
        {
          ...
          title: 'Crea contenido impactante',
        ...
        },
        {
          ...
          title: 'Optimiza tu presencia en línea',
          description: 'Descubre las técnicas para aumentar tu visibilidad, posicionar tu marca y destacar en las plataformas de redes sociales más populares.',
        },
        {
          ...
          title: 'Analiza y mejora tus resultados',
          description: 'Domina el arte del análisis de métricas para entender el rendimiento de tus campañas y tomar decisiones informadas que impulsen tu crecimiento.',
        },
      ];
